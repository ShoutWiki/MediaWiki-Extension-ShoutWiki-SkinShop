...
class SpecialSkinShop extends SpecialPage {
	...
	public function execute( $par ) {
		 ...
		 * @TODO: Integrate more payment options, make skin dropdown use $wgSkinShopAvailable and make less non-specific.
		 */
		$out->addHTML( '
			<div id="skinshop-payment">
				...
				<tr><td><input type="hidden" name="on1" value="Domain">' . wfMessage( 'skinshop-domain' )->plain() . '</td></tr><tr><td><input type="text" name="os1" maxlength="200" required="required" /></td></tr>
				</table>
